...
- Python 3.14 is now the minimum supported runtime; uv, Ruff, mypy, tox, and local setup target 3.14.
...
- The obsolete Poetry lock; `uv.lock` is the only dependency lock.
