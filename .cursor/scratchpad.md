...
**Task Completion Status**: Task 01-rename-source-directory completed (validation complete; pytest/mypy in target-gcs expected to fail until task 03). Task 02-update-plugin-config completed. Task 03-update-python-imports-and-tests completed. Task 04-update-repository-tooling completed.  
