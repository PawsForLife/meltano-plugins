...
- **Task Completion Status:** Task 01-add-decimal-regression-test completed, tests passing; Task 02-add-non-serializable-type-error-test completed, tests passing; Task 03-add-json-default-helper-and-import completed, tests passing
